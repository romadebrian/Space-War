...
public class RunGameActivity extends AppCompatActivity implements View.OnTouchListener, View.OnClickListener{
    ...
    ImageView m_BackgroundOne, m_BackgroundTwo, m_BackgroundFade;
    ImageView m_PlayerIv;
    ImageView m_AsteroidOneIv, m_AsteroidTwoIv, m_AsteroidThreeIv;
    ImageView m_EnemyOneIv, m_EnemyTwoIv, m_EnemyThreeIv, m_EnemyFourIv, m_EnemyFiveIv, m_EnemySixIv,m_EnemyKingIv;
    ImageView m_EnemyKingShotIv,m_ShotsIv ,m_GiftIv;
    ImageView m_HeartOneIv, m_HeartTwoIv , m_HeartThreeIv, m_BrokenHeartIv;
    Button m_HomeButton, m_PauseButton, m_PlayButton;
    TextView m_ScoreTv, m_LevelTv;


    // Animations vars
    private ValueAnimator m_BackgroundMoveAnim;
    private AlphaAnimation m_BackgroundFadeAnim;
    private Animation m_AnimationSpaceShipBlink, m_ExplodeAnim, m_AnimationKingBlink, m_AnimationEnemyBlink, m_AnimationFadeInOut, m_AnimationKingUpToDown;
    private AnimationDrawable m_EnemyOneAnim, m_EnemyTwoAnim, m_EnemyThreeAnim, m_EnemyFourAnim, m_EnemyFiveAnim, m_EnemySixAnim, m_KingAnim;
    private AnimationDrawable m_EnemyExplodeDrawableAnim, m_KingExplodeDrawableAnim;
    private AnimationDrawable m_AsteroidOneAnim, m_AsteroidTwoAnim, m_AsteroidThreeAnim;

    //boolean for king enemy
    private boolean m_IsKingMoveLeft = true, m_IsKingDead = false, m_KingIsAbove = true, m_KingAnimationNotStart = true;

    //members for onTouch listener
    private int m_XDelta, m_YDelta, m_LastAction;
    private boolean isStart = true, isPause = false, isMove = false, isPlay = true, isInIntent = true;
